...
ext_pyc = ["pyc",     # python byte-compiled
          ]

ext_jbin = ["class",     # java byte-compiled
          ]

ext_pe32 = ["pe32",     # PE32 compiled
          ]

ext_elf = ["elf",     # PE32 compiled
          ]
...
extensions = ext_py + ext_cpp + ext_java + ext_cs + ext_rb + ext_go +\
             ...
             ext_pro + ext_rs + ext_smali + ext_v + ext_pyc + ext_jbin +\
             ext_pe32 + ext_elf
